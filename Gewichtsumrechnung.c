...
static void total_weight_kg_test(void) {
    check_within_d(total_weight_kg(sa_of_String("10", "kg", "500", "g", "0.5", "t")), 10 + 0.5 + 500); //Vorgegebenes Bsp.
	check_within_d(total_weight_kg(sa_of_String("8000", "g", "20", "kg", "0.04", "t")), 8 + 20 + 40); //Bsp:1
	check_within_d(total_weight_kg(sa_of_String("5", "t", "0.4", "t", "23000", "g")), 5000 + 400 + 23); //Bsp:2
	check_within_d(total_weight_kg(sa_of_String("500", "g", "800", "g", "0.9", "kg")), 0.5 + 0.8 + 0.9); //Bsp:3
